...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.2)", date = "2017-1-31")
public class TaskInfo implements org.apache.thrift.TBase<TaskInfo, TaskInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TaskInfo> {
  ...
  private static final org.apache.thrift.protocol.TField STAGE_ATTEMP_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("stageAttempId", org.apache.thrift.protocol.TType.I32, (short)3);
  ...
  public int stageAttempId; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    STAGE_ATTEMP_ID((short)3, "stageAttempId"),
    ...
    PEAK_MEMORY_USAGE((short)9, "peakMemoryUsage"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 2: // STAGE_ID
          return STAGE_ID;
        case 3: // STAGE_ATTEMP_ID
          return STAGE_ATTEMP_ID;
        case 4: // JOB_ID
          return JOB_ID;
        case 5: // APP_ID
          return APP_ID;
  ...
  private static final int __STAGEATTEMPID_ISSET_ID = 2;
  ...
  private static final int __PEAKMEMORYUSAGE_ISSET_ID = 7;
  ...
  static {
    ...
    tmpMap.put(_Fields.STAGE_ATTEMP_ID, new org.apache.thrift.meta_data.FieldMetaData("stageAttempId", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public TaskInfo(TaskInfo other) {
    ...
    this.stageAttempId = other.stageAttempId;
  ...
  public void clear() {
    ...
    this.stageId = 0;
    setStageAttempIdIsSet(false);
    this.stageAttempId = 0;
    setJobIdIsSet(false);
    this.jobId = 0;
    this.appId = null;
  ...
  public int getStageAttempId() {
    return this.stageAttempId;
  }

  public TaskInfo setStageAttempId(int stageAttempId) {
    this.stageAttempId = stageAttempId;
    setStageAttempIdIsSet(true);
    return this;
  }

  public void unsetStageAttempId() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __STAGEATTEMPID_ISSET_ID);
  }

  /** Returns true if field stageAttempId is set (has been assigned a value) and false otherwise */
  public boolean isSetStageAttempId() {
    return EncodingUtils.testBit(__isset_bitfield, __STAGEATTEMPID_ISSET_ID);
  }

  public void setStageAttempIdIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __STAGEATTEMPID_ISSET_ID, value);
  }
  ...
  public void unsetPeakMemoryUsage() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __PEAKMEMORYUSAGE_ISSET_ID);
  }

  /** Returns true if field peakMemoryUsage is set (has been assigned a value) and false otherwise */
  public boolean isSetPeakMemoryUsage() {
    return EncodingUtils.testBit(__isset_bitfield, __PEAKMEMORYUSAGE_ISSET_ID);
  }

  public void setPeakMemoryUsageIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __PEAKMEMORYUSAGE_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case STAGE_ATTEMP_ID:
      if (value == null) {
        unsetStageAttempId();
      } else {
        setStageAttempId((Integer)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case STAGE_ATTEMP_ID:
      return Integer.valueOf(getStageAttempId());
  ...
  public boolean equals(TaskInfo that) {
    ...
    boolean this_present_stageAttempId = true;
    boolean that_present_stageAttempId = true;
    if (this_present_stageAttempId || that_present_stageAttempId) {
      if (!(this_present_stageAttempId && that_present_stageAttempId))
        return false;
      if (this.stageAttempId != that.stageAttempId)
        return false;
    }
    ...
    boolean this_present_peakMemoryUsage = true;
    boolean that_present_peakMemoryUsage = true;
    if (this_present_peakMemoryUsage || that_present_peakMemoryUsage) {
      if (!(this_present_peakMemoryUsage && that_present_peakMemoryUsage))
        return false;
      if (this.peakMemoryUsage != that.peakMemoryUsage)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_stageAttempId = true;
    list.add(present_stageAttempId);
    if (present_stageAttempId)
      list.add(stageAttempId);
    ...
    boolean present_peakMemoryUsage = true;
    list.add(present_peakMemoryUsage);
    if (present_peakMemoryUsage)
      list.add(peakMemoryUsage);
  ...
  public int compareTo(TaskInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetStageAttempId()).compareTo(other.isSetStageAttempId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStageAttempId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.stageAttempId, other.stageAttempId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetPeakMemoryUsage()).compareTo(other.isSetPeakMemoryUsage());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPeakMemoryUsage()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.peakMemoryUsage, other.peakMemoryUsage);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("stageAttempId:");
    sb.append(this.stageAttempId);
    first = false;
    if (!first) sb.append(", ");
    sb.append("jobId:");
    ...
    sb.append(this.peakMemoryUsage);
    first = false;
    if (!first) sb.append(", ");
    sb.append("status:");
    if (this.status == null) {
  ...
  private static class TaskInfoStandardScheme extends StandardScheme<TaskInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TaskInfo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // STAGE_ATTEMP_ID
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.stageAttempId = iprot.readI32();
              struct.setStageAttempIdIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TaskInfo struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(STAGE_ATTEMP_ID_FIELD_DESC);
      oprot.writeI32(struct.stageAttempId);
      oprot.writeFieldEnd();
