...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.2)", date = "2017-2-7")
public class TaskEndEvent implements org.apache.thrift.TBase<TaskEndEvent, TaskEndEvent._Fields>, java.io.Serializable, Cloneable, Comparable<TaskEndEvent> {
  ...
  private static final org.apache.thrift.protocol.TField TIME_STEMP_FIELD_DESC = new org.apache.thrift.protocol.TField("timeStemp", org.apache.thrift.protocol.TType.I64, (short)5);
  ...
  public long timeStemp; // required
  ...
  private static final int __TIMESTEMP_ISSET_ID = 3;
  ...
  static {
    ...
    tmpMap.put(_Fields.TIME_STEMP, new org.apache.thrift.meta_data.FieldMetaData("timeStemp", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
  ...
  public TaskEndEvent(TaskEndEvent other) {
    ...
    this.timeStemp = other.timeStemp;
  ...
  public TaskEndEvent setTimeStemp(long timeStemp) {
    this.timeStemp = timeStemp;
    setTimeStempIsSet(true);
    return this;
  }

  public void unsetTimeStemp() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __TIMESTEMP_ISSET_ID);
  }

  /** Returns true if field timeStemp is set (has been assigned a value) and false otherwise */
  public boolean isSetTimeStemp() {
    return EncodingUtils.testBit(__isset_bitfield, __TIMESTEMP_ISSET_ID);
  }

  public void setTimeStempIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __TIMESTEMP_ISSET_ID, value);
  }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case TIME_STEMP:
      return Long.valueOf(getTimeStemp());
  ...
  public boolean equals(TaskEndEvent that) {
    ...
    boolean this_present_timeStemp = true;
    boolean that_present_timeStemp = true;
    if (this_present_timeStemp || that_present_timeStemp) {
      if (!(this_present_timeStemp && that_present_timeStemp))
        return false;
      if (this.timeStemp != that.timeStemp)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_timeStemp = true;
    list.add(present_timeStemp);
    if (present_timeStemp)
      list.add(timeStemp);
  ...
  public int compareTo(TaskEndEvent other) {
    ...
    lastComparison = Boolean.valueOf(isSetTimeStemp()).compareTo(other.isSetTimeStemp());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTimeStemp()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.timeStemp, other.timeStemp);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TaskEndEventStandardScheme extends StandardScheme<TaskEndEvent> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TaskEndEvent struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // TIME_STEMP
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.timeStemp = iprot.readI64();
              struct.setTimeStempIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TaskEndEvent struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      oprot.writeFieldBegin(TIME_STEMP_FIELD_DESC);
      oprot.writeI64(struct.timeStemp);
      oprot.writeFieldEnd();
  ...
  private static class TaskEndEventTupleScheme extends TupleScheme<TaskEndEvent> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TaskEndEvent struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TaskEndEvent struct) throws org.apache.thrift.TException {
